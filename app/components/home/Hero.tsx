    ...
    <main>
      <PosterWrapper poster={poster}>
        <div className="absolute bottom-[200px] pl-14 min-[800px]:pl-20 flex flex-col justify-center select-none">
          <p className="text-4xl min-[1000px]:text-5xl min-[2000px]:text-6xl font-medium max-[700px]:pr-5">{selected?.title}</p>
          ...
          <div className="flex gap-x-3">
            ...
            <div className="border-2 border-gray-700 w-fit py-1.5 px-3 mt-4 rounded-lg cursor-pointer shadow-lg hover:scale-105 duration-300 flex items-center gap-x-1">
              <IconPlus className="min-[600px]:w-8 min-[600px]:h-8 min-[2000px]:w-10 min-[2000px]:h-10 p-0.5" />
              <p className="min-[600px]:text-lg min-[2000px]:text-xl">Watchlist</p>
            </div>
          </div>
        </div>
      </PosterWrapper>
